...
show_channels(void)
{
	...
	fprintf(stderr, "103ch: NHK BSプレミアム\n");
	fprintf(stderr, "141ch: BS日テレ\n");
	fprintf(stderr, "151ch: BS朝日\n");
	fprintf(stderr, "161ch: BS-TBS\n");
	fprintf(stderr, "171ch: BSテレ東\n");
	fprintf(stderr, "181ch: BSフジ\n");
	fprintf(stderr, "191ch: WOWOWプライム\n");
	fprintf(stderr, "192ch: WOWOWライブ\n");
	fprintf(stderr, "193ch: WOWOWシネマ\n");
	fprintf(stderr, "200ch: スターチャンネル1\n");
	fprintf(stderr, "201ch: スターチャンネル2\n");
	fprintf(stderr, "202ch: スターチャンネル3\n");
	fprintf(stderr, "211ch: BS11\n");
	fprintf(stderr, "222ch: BS12\n");
	fprintf(stderr, "231ch: BSキャンパスex\n");
	fprintf(stderr, "232ch: BSキャンパスon\n");
	fprintf(stderr, "234ch: グリーンチャンネル\n");
	fprintf(stderr, "236ch: BSアニマックス\n");
	fprintf(stderr, "241ch: BSスカパー!\n");
	...
	fprintf(stderr, "251ch: BS釣りビジョン\n");
	fprintf(stderr, "252ch: WOWOWプラス\n");
	fprintf(stderr, "255ch: 日本映画専門チャンネル\n");
	fprintf(stderr, "256ch: ディズニー・チャンネル\n");
	fprintf(stderr, "C13-C63: CATVチャンネル\n");
	fprintf(stderr, "CS2-CS24: CSチャンネル\n");
	fprintf(stderr, "BS1_0-BS23_1: BSチャンネル\n");
	fprintf(stderr, "0x4000-0x7FFF: BS/CSチャンネル(TSID)\n");
}
